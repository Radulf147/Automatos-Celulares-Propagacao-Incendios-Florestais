...
PROPRIEDADES_MATERIAIS = {
    0: {"nome": "Grama Seca",   "prob_base": 0.80, "tempo_queima": 1, "cor": (154, 205, 50)}, # Verde Amarelado
    1: {"nome": "Arbusto Seco", "prob_base": 0.50, "tempo_queima": 2, "cor": (218, 165, 32)}, # Dourado
    2: {"nome": "Folha Umida",  "prob_base": 0.15, "tempo_queima": 2, "cor": (85, 107, 47)},  # Verde Oliva Escuro
    3: {"nome": "Madeira Seca", "prob_base": 0.30, "tempo_queima": 5, "cor": (139, 69, 19)},  # Marrom
    4: {"nome": "Arvore Umida", "prob_base": 0.05, "tempo_queima": 8, "cor": (34, 139, 34)},  # Verde Floresta
    ...
    -2: {"nome": "Queimado",    "prob_base": 0.00, "tempo_queima": 0, "cor": (50,  50,  50)}  # Cinza Escuro
}
